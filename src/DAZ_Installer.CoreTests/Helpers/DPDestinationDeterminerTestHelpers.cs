...
namespace DAZ_Installer.Core.Tests.Helpers
{
    ...
    {
        public static void AssertDestinations(HashSet<IDPFile> expected, HashSet<IDPFile> actual, string basePath)
        {
        ...
        /// <summary>
        /// Asserts that all files in the archive have the correct <see cref="IDPFile.TargetPath"/>s.
        /// </summary>
        ...
        public static void AssertTargetPaths(HashSet<IDPFile> actual, IEnumerable<string> expectedPaths)
        {
        ...
        public static void AssertRelativePaths(IDPArchive arc, IEnumerable<string> expectedRTPaths, IEnumerable<string> expectedRPTCFPaths)
        {
        ...
        public static void AssertContentFolders(IDPArchive arc, IEnumerable<string> expectedContentFolderPaths)
        {
