...
namespace DAZ_Installer
{
	...
	[MarshalAs(UnmanagedType.LPWStr)] string destName);
		...
		public void Skip()
		{
			int result = RAR.RARProcessFileW(this.archiveHandle, (int)Operation.Skip, string.Empty, string.Empty);
		...
		public void Test()
		{
			int result = RAR.RARProcessFileW(this.archiveHandle, (int)Operation.Test, string.Empty, string.Empty);
		...
		{
			int result = RAR.RARProcessFileW(this.archiveHandle, (int)Operation.Extract, destinationPath, destinationName);
