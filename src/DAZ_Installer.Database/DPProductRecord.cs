...
namespace DAZ_Installer.Database
{
    ...
    /// <param name="Date">The date/time at which the product was installed.</param>
    ...
    public record DPProductRecord(string Name, IReadOnlyList<string> Authors, DateTime Date, string? ThumbnailPath, 
